...
class Admin():
    ...
    def AddBlackList(self, target_board_name, target_user_id):
        ...
        if "" in [target_board_name, target_user_id]:
            ...
            if userid_[0] == 0 and board_name_[0] == 0:
                ...
                curs.execute(InsertToBlackList, (target_board_name, target_user_id, ))
                conn.commit()
    ...
    def RemoveBlackList(self, target_board_name, target_user_id):
        ...
        if "" in [target_board_name, target_user_id]:
            ...
            if userid_[0] == 0 and board_name_[0] == 0:
                ...
                curs.execute(RemoveFromBlackList, (target_user_id, target_board_name, ))
                conn.commit()
    ...
    def BoardCreate(self, board_name):
        ...
        CreateBoard = u"INSERT INTO Board(board_name, write_auth) VALUES (%s, 1)"
